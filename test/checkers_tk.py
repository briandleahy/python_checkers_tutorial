...
class CheckersGUI(tk.Frame):
    ...
    def create_canvas(self):
        ...
        # Hint 3: You need to call the grid() method of the canvas
        ...
        self.canvas.grid()  # needs to be here
    ...
    def _charpos_to_xypos(self, charpos):
        ...
        y, x : Int
            ...
            Note that (y, x) = (0,0) is the upper-left-most pixel on 
        ...
        # the pixel that is i pixels _down_ from the top left corner
        raise NotImplementedError
